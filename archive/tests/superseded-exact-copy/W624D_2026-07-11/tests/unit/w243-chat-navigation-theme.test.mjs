...
test('W243 keeps a simple ChatGPT-style public navigation with one canonical EONAPP hierarchy', () => {
...
test('W243 applies Graphite, Obsidian, or Neon Night before core-route styles render', () => {
