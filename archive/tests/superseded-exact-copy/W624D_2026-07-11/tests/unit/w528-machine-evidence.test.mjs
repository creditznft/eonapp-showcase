...
test('W528 prepares source and emulated-browser coverage without starting a browser or claiming a device result', () => {
...
test('W528 source gate remains local-only and rejects runtime evidence inflation', () => {
