...
test('W520 core seams reduce all four orchestrators and add no boundary cycle', () => {
...
test('W520 shell contract preserves canonical routes and keyboard-native navigation markup', () => {
