...
test('W534 generated index is deterministic and preserves historical material without treating it as a release instruction', () => {
...
test('W534 physically quarantines the obsolete P2P e2e diagnostic', () => {
