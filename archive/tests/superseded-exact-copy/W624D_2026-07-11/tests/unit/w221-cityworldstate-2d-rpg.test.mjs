...
test('W221 ships an actual canvas-based 2D City input contract with no hidden economy or legacy 3D boot', () => {
  ...
  const store = read('assets/js/city/city-world-state.js');
