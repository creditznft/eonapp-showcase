...
test('W239 quarantines nested legacy Tool and Game routes before production output', () => {
...
test('R4-COMM-01 makes Graphite the default and migrates retired legacy theme values safely', () => {
  ...
  const neonNightIndex = profile.indexOf('data-eon-theme-choice="neon-night"');
  assert.ok(graphiteIndex >= 0 && obsidianIndex > graphiteIndex && neonNightIndex > obsidianIndex, 'profile presents Graphite, Obsidian, then Neon Night.');
});
