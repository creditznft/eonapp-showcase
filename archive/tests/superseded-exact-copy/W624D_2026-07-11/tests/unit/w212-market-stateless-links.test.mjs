...
test('W212 has no Cloudflare short-link registry and no central write on link open', () => {
...
test('W212 Preview Studio has explicit private generation and server-truth commercial safeguards with no checkout or exchange claim', () => {
