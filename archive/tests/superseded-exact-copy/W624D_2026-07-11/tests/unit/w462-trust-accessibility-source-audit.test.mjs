...
test('W462.1 consolidates current a11y, language, voice and security source controls without claiming external proof', () => {
...
test('W462.1 static gate preserves the source-only external-evidence fence', () => {
