...
test.skip('W380 ships a compact reusable app shell and intentional app destinations', () => {
...
test.skip('W380 makes root the canonical chat document and keeps the generated redirects synchronized', () => {
