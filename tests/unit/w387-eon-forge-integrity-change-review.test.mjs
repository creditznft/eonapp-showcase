...
test('W387 adds local-only assets, import review and receipts while preserving local assets, review and deployment boundaries', () => {
  ...
  assert.match(html, /data-eon-forge="w(?:387|648)"/);
  assert.match(forge, /EON Forge (?:Integrity and Change Review|AI Developer Workspace)/);
  ...
  assert.match(forge, /No repository, connection, or publish action occurred|No repository or deployment was touched/);
