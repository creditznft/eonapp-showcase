...
test.skip('W219 removes chat credential capture while preserving secure Vault configuration routing', () => {
...
test.skip('W219 positions Workspace as AI Cockpit and keeps Local AI truthful', () => {
