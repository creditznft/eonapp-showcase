...
test('W386 upgrades EON Forge into a local developer workspace without claiming remote coding or deployment', () => {
  ...
  assert.match(html, /data-eon-forge="w38[67]"/);
  assert.match(forge, /EON Forge Developer Workspace/);
  ...
  assert.match(forge, /GitHub, Cloudflare and publishing are not connected/);
