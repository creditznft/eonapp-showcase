...
| `/blog` | Retired | `/archive` | `tests/unit/w217-route-contract.test.mjs` |
| `/blog/*` | Retired | `/archive` | `tests/unit/w217-route-contract.test.mjs` |
| `/telegram/index.html` | Retired | `/telegram` | `tests/unit/w217-route-contract.test.mjs` |
| `/telegram/*` | Retired | `/telegram` | `tests/unit/w217-route-contract.test.mjs` |
| `/nowpayments` | Retired | `/billing` | `tests/unit/w217-route-contract.test.mjs` |
| `/nowpayments/*` | Retired | `/billing` | `tests/unit/w217-route-contract.test.mjs` |
...
| AI Cockpit can prepare local signed-invite campaign drafts and approval queues, but it does not connect social accounts, auto-post, track clicks, or activate rewards, commission, or payouts. | Live | `/workspace`, `/profile`, `/referral` | `tests/unit/w223-invite-share-center.test.mjs`<br>`tests/unit/w228-ceo-red-team.test.mjs` |
