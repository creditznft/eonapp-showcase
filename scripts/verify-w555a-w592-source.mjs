#!/usr/bin/env node
/**
 * W592 canonical source verifier.
 *
 * Runs every W555A–W592 source gate once, the full bounded current-product
...
const SOURCE_GATES = Object.freeze([
  ...
  ['w591-eon-city-quality-summit', 'scripts/w591-eon-city-quality-summit-gate.mjs'],
  ['w592-eon-city-flagship-red-team', 'scripts/w592-eon-city-flagship-red-team-gate.mjs']
]);
...
const receipt = Object.freeze({
  schema: 'eon.city.w592.canonical-source-verifier.v1',
  ok: !failed,
  sourceOnly: true,
