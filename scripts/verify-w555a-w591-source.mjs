#!/usr/bin/env node
/**
 * W591 canonical source verifier.
 *
 * Runs every W555A–W591 source gate once, the full bounded current-product
...
const receipt = Object.freeze({
  schema: 'eon.city.w591.canonical-source-verifier.v1',
  ok: !failed,
  sourceOnly: true,
