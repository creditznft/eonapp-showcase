...
export function bindEonCityW659gProgression(root, { onStatus = () => {}, storage = globalThis.localStorage } = {}) {
  ...
  const render = () => {
    ...
    content.innerHTML = `
      ...
      <div class="eon-w659g-actions"><button class="eon-w659g-reveal" type="button" data-w659g-reveal${state.pendingReveals ? '' : ' disabled'}>Open Vault Reveal</button><a href="/workspace#eon-share">Share &amp; Earn</a><a href="/eon-keys">EONKEY unlocks</a><a href="/rewards?surface=eoncity">Reward Center</a></div>
      <p class="eon-w659g-truth">City XP and Vault Reveals are non-cash progression. Referral EONKEYS come only from verified server referral milestones. Sponsored Mission EONKEYS come only from trusted MyLead server postbacks for eligible conversions. City clicks, local play, browser returns and video playback cannot mint either.</p>
