...
export const EON_CITY_FAIRNESS_SAFETY_RULES = freeze([
  ...
  freeze({ id: 'rewarded-truth', title: 'Rewarded access truth', detail: 'Sponsor Terminal is voluntary. A server-validated rewarded completion can grant one consumable Sponsor Key for bounded short feature access. It never grants a whole subscription, cash value, hosted AI credit, random loot or pay-to-win progression.' }),
