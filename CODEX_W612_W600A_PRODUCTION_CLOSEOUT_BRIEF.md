...
> **historical-only W612 continuity record.** This handover is retained as provenance for the W612 source snapshot. Use `CURRENT_PRODUCT_START_HERE.md` and the current handover under `HANDOVER/` for active merge/deploy instructions.
